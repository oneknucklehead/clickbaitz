...
import dummyImg from "../assets/images/case1.jpg";
import dummyImg2 from "../assets/images/case2.jpg";
                        ...
                        <div id="accordionFlushExample">
                            <div
                                ...
                                <div
                                    ...
                                    <div className="py-4 px-5 grid grid-cols-2 lg:grid-cols-3 gap-4 text-white">
                                        ...
                                        >
                                            <span >Category</span>
                                            <span className="text-xs text-[#e0e0e0]">Clothing</span>
                                        </div>
                                        <div className="col-span-2 order-last lg:order-first lg:col-span-1 pb-4"
                                            data-aos="fade-up"
                                            data-aos-duration="1000"
                                        >
